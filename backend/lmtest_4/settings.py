"""
Django settings for lmtest_4 project.
...
WSGI_APPLICATION = 'lmtest_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lmtest_4 API",
    "DESCRIPTION": "API documentation for lmtest_4 App",
    "VERSION": "v1",
}
